...
class StoreClientRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'ine'=>'string|required|unique:clients|max:13|min:8',
            'rfc'=>'nullable|string|unique:clients|max:13|min:8',
            'address'=>'nullable|string|required|max:255',
            'phone'=>'string|nullable|unique:clients|max:15',
            'email'=>'string|nullable|unique:clients|max:255,name|email:rfc,dns'
        ];
    }
